...
from .transforms import get_pretrained_s2_train_transform, get_s2_train_transform, get_gsi_train_transform
...
class S2GeoDataModule(pl.LightningDataModule):
    ...
    def prepare_data(self) -> None:
        if not os.path.exists(self.data_dir):
            print (f"the dataset path is {self.data_dir}")
            print("""
